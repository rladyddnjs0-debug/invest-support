...
### 4. 💎 펀더멘털 가치평가 ([상세 로직](docs/fundamental_valuation.md))
...
### 5. 🚀 실시간 마켓 모니터
*   **초정밀 실시간 데이터**: TradingView의 실시간 라이브 차트 엔진을 직접 임베딩하여 5분봉 기준의 긴박한 가격 변화를 지연 없이 확인.
*   **통합 관제 보드**: 나스닥/S&P500 선물, 미국채 금리(10Y, 2Y), VIX, 달러 인덱스, 환율 등 핵심 시장 지표를 한곳에서 실시간 모니터링.

### 6. 🤖 AI 투자 리포트 ([상세 로직](docs/ai_agent.md))
